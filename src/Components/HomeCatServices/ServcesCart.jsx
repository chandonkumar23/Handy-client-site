...
const ServcesCart = ({service}) => {
    const {_id,service_image,service_description,service_name,service_provider_image,service_provider_name,service_price}=service;
    ...
    return (
        <div className="py-5">
             <div className="sm:block lg:border-4 rounded-md bg-white shadow-md p-5">               
               <div >
                    <img className="sm:block lg:h-[400px] w-full mx-auto" src={service_image} alt="" />
                    <p><span className="font-bold">Price</span> ${service_price}</p>
                  <div className="pt-5">
                 ...
                 <div><h1 className="text-xl lg:text-4xl font-bold">{service_name}</h1>
