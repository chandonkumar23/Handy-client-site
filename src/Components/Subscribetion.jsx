...
const Subscribetion = () => {
    return (
        <div className="p-10 my-10">
            <div className="h-[500px] w-11/12 mx-auto " style={{ backgroundImage: 'url(https://i.ibb.co.com/KzNGJVrH/court.jpg)' }}>
                <div className="hero-overlay bg-opacity-60"></div>
                <div className=" text-center ">
                    <div className="-mt-96 py-4">
                        <h1 className=" text-5xl font-bold italic text-slate-400 p-4">Subscribe</h1>
